...
static void
change_orient (Gde2PanelApplet *applet, Gde2PanelAppletOrient o, DriveList *drive_list)
{
...
static void
size_allocate (Gde2PanelApplet  *applet,
...
static void
change_background (Gde2PanelApplet               *applet,
		...
		gpointer     user_data)
{
	...
	change_orient (applet,
		       gde2_panel_applet_get_orient (applet),
...
GDE2_PANEL_APPLET_OUT_PROCESS_FACTORY (factory_iid,
				  PANEL_TYPE_APPLET,
				  "Drive-Mount-Applet",
				  applet_factory, NULL)
