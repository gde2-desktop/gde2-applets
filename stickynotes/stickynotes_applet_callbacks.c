...
void applet_change_orient_cb(Gde2PanelApplet *gde2_panel_applet, Gde2PanelAppletOrient orient, StickyNotesApplet *applet)
{
...
{
	if ((applet->panel_orient == GDE2_PANEL_APPLET_ORIENT_UP) || (applet->panel_orient == GDE2_PANEL_APPLET_ORIENT_DOWN)) {
...
void applet_destroy_cb (Gde2PanelApplet *gde2_panel_applet, StickyNotesApplet *applet)
{
	GList *notes;
	       ...
	       StickyNotesApplet *applet)
{
	...
	gde2_show_about_dialog (NULL,
		...
		"comments",	_("Sticky Notes for the "
				  "GDE2 Desktop Environment"),
		"authors",	authors,
		"documenters",	documenters,
		"translator-credits",	_("translator-credits"),
		"logo-icon-name",	"gde2-sticky-notes-applet",
		NULL);
}
...
void preferences_response_cb(GtkWidget *dialog, gint response, gpointer data)
{
	if (response == GTK_RESPONSE_HELP) {
		...
		gtk_show_uri (gtk_widget_get_screen (GTK_WIDGET (dialog)),
				"help:gde2-stickynotes-applet/stickynotes-advanced-settings",
				gtk_get_current_event_time (),
				&error);
		if (error) {
