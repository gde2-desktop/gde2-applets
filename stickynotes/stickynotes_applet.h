...
#define STICKYNOTES_SCHEMA	"org.gde2.stickynotes"
...
typedef struct
{
	...
	gint panel_size;
	Gde2PanelAppletOrient panel_orient;
...
void stickynotes_applet_init(Gde2PanelApplet *gde2_panel_applet);
void stickynotes_applet_init_prefs(void);

StickyNotesApplet * stickynotes_applet_new(Gde2PanelApplet *gde2_panel_applet);
