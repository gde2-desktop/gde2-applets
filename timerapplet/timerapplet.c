...
/* Applet constants */
#define APPLET_ICON  "gde2-panel-clock"
#define STEP         100

/* GSettings constants */
#define TIMER_SCHEMA            "org.gde2.panel.applet.timer"
...
static void
timer_applet_destroy (Gde2PanelApplet *applet_widget, TimerApplet *applet)
{
    g_assert (applet);
...
static gboolean
timer_applet_fill (Gde2PanelApplet* applet_widget)
{
    TimerApplet *applet;
    ...
    gde2_panel_applet_set_background_widget (GDE2_PANEL_APPLET (applet_widget), GTK_WIDGET (applet_widget));

    applet = g_malloc0(sizeof(TimerApplet));
    applet->applet = applet_widget;
    applet->settings = gde2_panel_applet_settings_new (applet_widget,TIMER_SCHEMA);
    applet->timeout_id = 0;
    applet->active = FALSE;
    applet->pause = FALSE;
    ...
    gde2_panel_applet_setup_menu (applet->applet, ui, applet->action_group);
...
static gboolean
timer_factory (Gde2PanelApplet* applet, const char* iid, gpointer data)
{
...
GDE2_PANEL_APPLET_OUT_PROCESS_FACTORY("TimerAppletFactory",
                                      PANEL_TYPE_APPLET,
                                      "Timer applet",
                                      timer_factory,
                                      NULL)
