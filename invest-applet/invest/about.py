...
from gde2_invest.defs import VERSION, GTK_API_VERSION
import gde2_invest
...
invest_logo = None
try:
	invest_logo = GdkPixbuf.Pixbuf.new_from_file_at_size(join(gde2_invest.ART_DATA_DIR, "invest_neutral.svg"), 96, 96)
