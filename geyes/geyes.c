	  ...
	  EyesApplet  *eyes_applet)
{
	...
	gde2_show_about_dialog (NULL,
		"version",	VERSION,
		"comments",	_("A goofy set of eyes for the GDE2 "
				  "panel. They follow your mouse."),
		"copyright",	"\xC2\xA9 1999 Dave Camp",
		"authors",	authors,
		"documenters",	documenters,
		"translator-credits",	_("translator-credits"),
		"logo-icon-name",	"gde2-eyes-applet",
		NULL);
}
...
static EyesApplet *
create_eyes (Gde2PanelApplet *applet)
{
	...
	eyes_applet->settings = 
		gde2_panel_applet_settings_new (applet, "org.gde2.panel.applet.geyes");
...
static gboolean
geyes_applet_fill (Gde2PanelApplet *applet)
{
	EyesApplet *eyes_applet;
	...
	gtk_window_set_default_icon_name ("gde2-eyes-applet");
	...
	gde2_panel_applet_setup_menu_from_file (eyes_applet->applet,
					   ui_path, action_group);
	g_free (ui_path);

	if (gde2_panel_applet_get_locked_down (eyes_applet->applet)) {
		GtkAction *action;
...
static gboolean
geyes_applet_factory (Gde2PanelApplet *applet,
		      const gchar *iid,
		      gpointer     data)
{
...
GDE2_PANEL_APPLET_OUT_PROCESS_FACTORY ("GeyesAppletFactory",
				  PANEL_TYPE_APPLET,
				  "geyes",
