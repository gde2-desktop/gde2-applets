...
#endif
static void     cpufreq_applet_change_orient     (Gde2PanelApplet        *pa,
                                                  Gde2PanelAppletOrient   orient);
...
static const gchar* const cpufreq_icons[] = {
	GDE2_PIXMAPSDIR "/gde2-cpufreq-applet/cpufreq-25.png",
	GDE2_PIXMAPSDIR "/gde2-cpufreq-applet/cpufreq-50.png",
	GDE2_PIXMAPSDIR "/gde2-cpufreq-applet/cpufreq-75.png",
	GDE2_PIXMAPSDIR "/gde2-cpufreq-applet/cpufreq-100.png",
	GDE2_PIXMAPSDIR "/gde2-cpufreq-applet/cpufreq-na.png",
	NULL
};
...
cpufreq_applet_init (CPUFreqApplet *applet)
{
	...
	applet->need_refresh = TRUE;
        ...
        gde2_panel_applet_set_flags (GDE2_PANEL_APPLET (applet), GDE2_PANEL_APPLET_EXPAND_MINOR);
	gde2_panel_applet_set_background_widget (GDE2_PANEL_APPLET (applet), GTK_WIDGET (applet));

        applet->size = gde2_panel_applet_get_size (GDE2_PANEL_APPLET (applet));
        applet->orient = gde2_panel_applet_get_orient (GDE2_PANEL_APPLET (applet));
...
#endif
{
	...
	if (applet->orient == GDE2_PANEL_APPLET_ORIENT_LEFT ||
	    applet->orient == GDE2_PANEL_APPLET_ORIENT_RIGHT)
		return;
                                    ...
                                    gpointer  gdata)
{
	...
	gtk_widget_get_allocation (widget, &allocation);
        ...
        switch (gde2_panel_applet_get_orient (GDE2_PANEL_APPLET (widget))) {
        case GDE2_PANEL_APPLET_ORIENT_DOWN:
        case GDE2_PANEL_APPLET_ORIENT_UP:
...
static void
cpufreq_applet_change_orient (Gde2PanelApplet *pa, Gde2PanelAppletOrient orient)
{
        CPUFreqApplet *applet;
        GtkAllocation  allocation;
        gint           size;
        ...
        if ((orient == GDE2_PANEL_APPLET_ORIENT_LEFT) ||
            (orient == GDE2_PANEL_APPLET_ORIENT_RIGHT)) {
                size = allocation.width;
                         ...
                         CPUFreqApplet *applet)
{
        ...
        gde2_show_about_dialog (NULL,
			       ...
			       "logo-icon-name",        "gde2-cpu-frequency-applet",
                               NULL);
}
...
cpufreq_applet_refresh (CPUFreqApplet *applet)
{
	...
	horizontal = (applet->orient == GDE2_PANEL_APPLET_ORIENT_UP ||
		      applet->orient == GDE2_PANEL_APPLET_ORIENT_DOWN);
...
cpufreq_applet_setup (CPUFreqApplet *applet)
{
	...
	gtk_window_set_default_icon_name ("gde2-cpu-frequency-applet");

        /* Preferences */
        if (applet->prefs)
                g_object_unref (applet->prefs);

        settings = gde2_panel_applet_settings_new (GDE2_PANEL_APPLET (applet), "org.gde2.panel.applet.cpufreq");
	...
	ui_path = g_build_filename (CPUFREQ_MENU_UI_DIR, "cpufreq-applet-menu.xml", NULL);
        gde2_panel_applet_setup_menu_from_file (GDE2_PANEL_APPLET (applet),
					   ui_path, action_group);
	g_free (ui_path);

        if (gde2_panel_applet_get_locked_down (GDE2_PANEL_APPLET (applet))) {
		GtkAction *action;
...
GDE2_PANEL_APPLET_OUT_PROCESS_FACTORY ("CPUFreqAppletFactory",
				  CPUFREQ_TYPE_APPLET,
				  "cpufreq-applet",
				  (Gde2PanelAppletFactoryCallback) cpufreq_applet_factory,
				  NULL)
