...
static AppletStockIcon stock_icons[] = {
	{ACCESSX_APPLET, "gde2-ax-applet.png", GTK_STATE_NORMAL, True},
	{ACCESSX_BASE_ICON, "gde2-ax-key-base.png", GTK_STATE_NORMAL, True},
	{ACCESSX_BASE_ICON, "gde2-ax-key-none.png", GTK_STATE_INSENSITIVE, False},
	{ACCESSX_BASE_ICON, "gde2-ax-key-inverse.png", GTK_STATE_SELECTED, False},
	{ACCESSX_ACCEPT_BASE, "gde2-ax-key-yes.png", GTK_STATE_NORMAL, True},
	{ACCESSX_REJECT_BASE, "gde2-ax-key-no.png", GTK_STATE_NORMAL, True},
	{MOUSEKEYS_BASE_ICON, "gde2-mousekeys-base.png", GTK_STATE_NORMAL, True},
	{MOUSEKEYS_BUTTON_LEFT, "gde2-mousekeys-pressed-left.png", GTK_STATE_NORMAL, True},
	{MOUSEKEYS_BUTTON_MIDDLE, "gde2-mousekeys-pressed-middle.png", GTK_STATE_NORMAL, True},
	{MOUSEKEYS_BUTTON_RIGHT, "gde2-mousekeys-pressed-right.png", GTK_STATE_NORMAL, True},
	{MOUSEKEYS_DOT_LEFT, "gde2-mousekeys-default-left.png", GTK_STATE_NORMAL, True},
	{MOUSEKEYS_DOT_MIDDLE, "gde2-mousekeys-default-middle.png", GTK_STATE_NORMAL, True},
	{MOUSEKEYS_DOT_RIGHT, "gde2-mousekeys-default-right.png", GTK_STATE_NORMAL, True},
	{SHIFT_KEY_ICON, "gde2-sticky-shift-latched.png", GTK_STATE_NORMAL, False},
	{SHIFT_KEY_ICON, "gde2-sticky-shift-locked.png", GTK_STATE_SELECTED, False},
	{SHIFT_KEY_ICON, "gde2-sticky-shift-none.png", GTK_STATE_INSENSITIVE, True},
	{CONTROL_KEY_ICON, "gde2-sticky-ctrl-latched.png", GTK_STATE_NORMAL, False},
	{CONTROL_KEY_ICON, "gde2-sticky-ctrl-locked.png", GTK_STATE_SELECTED, False},
	{CONTROL_KEY_ICON, "gde2-sticky-ctrl-none.png", GTK_STATE_INSENSITIVE, True},
	{ALT_KEY_ICON, "gde2-sticky-alt-latched.png", GTK_STATE_NORMAL, False},
	{ALT_KEY_ICON, "gde2-sticky-alt-locked.png", GTK_STATE_SELECTED, False},
	{ALT_KEY_ICON, "gde2-sticky-alt-none.png", GTK_STATE_INSENSITIVE, True},
	{META_KEY_ICON, "gde2-sticky-meta-latched.png", GTK_STATE_NORMAL, False},
	{META_KEY_ICON, "gde2-sticky-meta-locked.png", GTK_STATE_SELECTED, False},
	{META_KEY_ICON, "gde2-sticky-meta-none.png", GTK_STATE_INSENSITIVE, True},
	{SUPER_KEY_ICON, "gde2-sticky-super-latched.png", GTK_STATE_NORMAL, False},
	{SUPER_KEY_ICON, "gde2-sticky-super-locked.png", GTK_STATE_SELECTED, False},
	{SUPER_KEY_ICON, "gde2-sticky-super-none.png", GTK_STATE_INSENSITIVE, True},
	{HYPER_KEY_ICON, "gde2-sticky-hyper-latched.png", GTK_STATE_NORMAL, False},
	{HYPER_KEY_ICON, "gde2-sticky-hyper-locked.png", GTK_STATE_SELECTED, False},
	{HYPER_KEY_ICON, "gde2-sticky-hyper-none.png", GTK_STATE_INSENSITIVE, True},
	{SLOWKEYS_IDLE_ICON, "gde2-ax-slowkeys.png", GTK_STATE_NORMAL, True},
	{SLOWKEYS_PENDING_ICON, "gde2-ax-slowkeys-pending.png", GTK_STATE_NORMAL, True},
	{SLOWKEYS_ACCEPT_ICON, "gde2-ax-slowkeys-yes.png", GTK_STATE_NORMAL, True},
	{SLOWKEYS_REJECT_ICON, "gde2-ax-slowkeys-no.png", GTK_STATE_NORMAL, True},
	{BOUNCEKEYS_ICON, "gde2-ax-bouncekeys.png", GTK_STATE_NORMAL, True}
};
...
static void help_cb(GtkAction* action, AccessxStatusApplet* sapplet)
{
	...
	gtk_show_uri(screen, "help:gde2-accessx-status", gtk_get_current_event_time(), &error);
...
static void dialog_cb(GtkAction* action, AccessxStatusApplet* sapplet)
{
	...
	appinfo = g_app_info_create_from_commandline ("gde2-keyboard-properties --a11y",
...
static AccessxStatusApplet* create_applet(Gde2PanelApplet* applet)
{
	...
	sapplet->orient = gde2_panel_applet_get_orient(applet);

	if (sapplet->orient == GDE2_PANEL_APPLET_ORIENT_LEFT || sapplet->orient == GDE2_PANEL_APPLET_ORIENT_RIGHT)
	{
	...
	if (gde2_panel_applet_get_size(sapplet->applet) >= large_toolbar_pixels)
	{
...
static void accessx_status_applet_reorient(GtkWidget* widget, Gde2PanelAppletOrient o, gpointer user_data)
{
	AccessxStatusApplet* sapplet = user_data;
	GtkWidget* box;
	GtkWidget* stickyfoo;
	...
	if (o == GDE2_PANEL_APPLET_ORIENT_LEFT || o == GDE2_PANEL_APPLET_ORIENT_RIGHT)
	{
		box = gtk_vbox_new(FALSE, 0);
		stickyfoo = gtk_vbox_new(TRUE, 0);
	}
...
static gboolean accessx_status_applet_reset(gpointer user_data)
{
	AccessxStatusApplet* sapplet = user_data;
	g_assert(sapplet->applet);
	accessx_status_applet_reorient(GTK_WIDGET(sapplet->applet), gde2_panel_applet_get_orient(sapplet->applet), sapplet);
...
static gboolean accessx_status_applet_fill(Gde2PanelApplet* applet)
{
	...
	gde2_panel_applet_setup_menu_from_file(sapplet->applet, ui_path, action_group);
	g_free(ui_path);

	if (gde2_panel_applet_get_locked_down(sapplet->applet))
	{
	...
	gde2_panel_applet_set_background_widget (sapplet->applet, GTK_WIDGET (sapplet->applet));

	return TRUE;
}

static gboolean accessx_status_applet_factory(Gde2PanelApplet* applet, const gchar* iid, gpointer data)
{
	gboolean retval = FALSE;
...
GDE2_PANEL_APPLET_OUT_PROCESS_FACTORY("AccessxStatusAppletFactory", PANEL_TYPE_APPLET, "accessx-status", accessx_status_applet_factory, NULL)
