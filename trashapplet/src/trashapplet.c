...
typedef Gde2PanelAppletClass TrashAppletClass;
  ...
  if (event->button == 1)
    {
      if (g_settings_get_boolean (settings, PANEL_ENABLE_ANIMATIONS))
        xstuff_zoom_anigde2 (widget, NULL);
                         ...
                         TrashApplet *applet)
{
  ...
  gde2_show_about_dialog (NULL,
                         ...
                         "comments", _("A GDE2 trash bin that lives in your panel. "
...
static gboolean
trash_applet_factory (Gde2PanelApplet *applet,
                      const gchar *iid,
                      gpointer     data)
{
...
GDE2_PANEL_APPLET_OUT_PROCESS_FACTORY ("TrashAppletFactory",
				  TRASH_TYPE_APPLET,
				  "TrashApplet",
