/* GDE2 cpuload/memload panel applet
	...
	switch (arg)
	{
		case GTK_RESPONSE_HELP:
			...
			gtk_show_uri (gtk_widget_get_screen (GTK_WIDGET (ma->applet)),
					"help:gde2-multiload/multiload-prefs",
...
fill_properties(GtkWidget *dialog, MultiloadApplet *ma)
{
	...
	orient = gde2_panel_applet_get_orient(ma->applet);
	if ( (orient == GDE2_PANEL_APPLET_ORIENT_UP) || (orient == GDE2_PANEL_APPLET_ORIENT_DOWN) )
